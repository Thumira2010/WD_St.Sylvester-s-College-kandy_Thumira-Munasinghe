...
const FriendOrFoe = () => {
  ...
  return (
    <section id="friend-or-foe" ref={sectionRef} className="py-20 md:py-32 px-4 relative overflow-hidden opacity-0">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">
            <span className="glow-text-cyan">Friend</span>
            {" or "}
            <span className="glow-text-violet">Foe</span>?
          </h2>
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-0 relative">
          {/* Vertical Divider */}
          <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-secondary to-accent glow-cyan"></div>

          {/* Friend Side */}
          <div className="p-8 lg:p-12 bg-gradient-to-r from-primary/10 to-transparent rounded-l-2xl">
            <div className="flex items-center gap-4 mb-8">
              <div className="p-4 rounded-full bg-primary/20 glow-cyan">
                <Check className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-3xl font-heading font-bold text-primary glow-text-cyan">
                Friend
              </h3>
            </div>
          ...
          <div className="p-8 lg:p-12 bg-gradient-to-l from-secondary/10 to-transparent rounded-r-2xl">
            <div className="flex items-center gap-4 mb-8 justify-end">
              <h3 className="text-3xl font-heading font-bold text-secondary glow-text-violet">
                Foe
              </h3>
              <div className="p-4 rounded-full bg-secondary/20 glow-violet">
        ...
        <div className="md:hidden space-y-8">
          ...
          <div className="p-6 glass rounded-2xl">
            <div className="flex items-center gap-4 mb-6">
              <div className="p-3 rounded-full bg-primary/20 glow-cyan">
                <Check className="h-6 w-6 text-primary" />
              </div>
              <h3 className="text-2xl font-heading font-bold text-primary glow-text-cyan">
                Friend
              </h3>
            </div>
          ...
          <div className="p-6 glass rounded-2xl">
            <div className="flex items-center gap-4 mb-6">
              <div className="p-3 rounded-full bg-secondary/20 glow-violet">
                <X className="h-6 w-6 text-secondary" />
              </div>
              <h3 className="text-2xl font-heading font-bold text-secondary glow-text-violet">
                Foe
              </h3>
            </div>
            <div className="space-y-3">
